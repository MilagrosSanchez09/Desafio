...
let cartDao;
let ticketDao;
const persistence = process.argv[2] || "FS"; // toma de línea de comando
switch (persistence) {
    case "FS":
        ...
        console.log('userDao para persistencia en filesystem:', userDao);
        break;
    case "MONGO":
        await initMongoDB();
        ...
        console.log(persistence);
        console.log('userDao para persistencia en MongoDB:', userDao);
        break;
    default:
        console.error('Invalid persistence option');
        process.exit(1);
}
